    ...
    <div className="app">
      ...
      >
        <section className="hero">
          <h1 id="heroTitle">
            {birthdayReached ? (
              <>
                Happy Birthday <span className="highlight">Babyy</span> 🎂
              </>
            ) : (
              <>
                Counting down to <span className="highlight">my baby’s</span> special day 🎂
              </>
            )}
          </h1>
          <p> ILOVE YOU TO THE STARS AND BEYOND 💗</p>
        </section>
      ...
      >
        ...
        <section className="final">
          <h2 className="final-message">💖 Forever Yours — Shashank 💖</h2>
          <p className="final-subtitle"> ILOVEYOUTHESTARSANDBEYOND ✨</p>
        </section>
      </div>
